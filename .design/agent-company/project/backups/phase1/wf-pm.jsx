      ...
      <div style={{ display: "flex", flexDirection: "column", flex: 1, minHeight: 0 }}>
        ...
        <div style={{ display: "flex", flex: 1, minHeight: 0 }}>
          ...
          <PMShell activeTab="chat">
            ...
            <div style={{ flex: 1, minHeight: 0, overflow: "auto", padding: "14px 18px 14px" }}>
        ...
        <div style={{ display: "flex", flex: 1, minHeight: 0 }}>
          ...
          <PMShell activeTab="chat">
            ...
            <div style={{ flex: 1, minHeight: 0, display: "flex", gap: 14, padding: "14px 18px 0", overflow: "hidden" }}>
              ...
              <div style={{ flex: "0 0 280px", overflow: "auto", paddingBottom: 8, display: "flex", flexDirection: "column" }} data-comment-anchor="33cdb55800-div-247-15">
