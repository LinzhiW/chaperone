        ...
        <div style={{ display: "flex", flex: 1, minHeight: 0 }}>
          ...
          <div style={{ flex: 1, display: "flex", flexDirection: "column", minHeight: 0, background: "var(--paper-2)" }}>
            ...
            <div style={{ flex: 1, padding: 12, display: "flex", flexDirection: "column", gap: 10, minHeight: 0 }}>
              ...
              <div style={{ flex: 1, display: "grid", gridTemplateColumns: "minmax(320px, 1fr) 1.5fr", gap: 10, minHeight: 0 }}>
                ...
                {/* Diff preview */}
                <div className="box" style={{ padding: 0, display: "flex", flexDirection: "column", minHeight: 0, overflow: "hidden", background: "var(--paper)" }}>
                  <div style={{ padding: "6px 12px", borderBottom: "1.5px solid var(--rule)", background: "var(--paper-2)", fontSize: 12, display: "flex", alignItems: "center", gap: 8 }}>
                    <span style={{ fontFamily: "var(--mono)", fontSize: 11 }}>src/components/Header.jsx</span>
                    <span style={{ fontSize: 10, color: "var(--ink-3)" }}>touched by</span>
              ...
              <div className="box" style={{ padding: 0, background: "var(--paper)", display: "flex", flexDirection: "column" }}>
                <div style={{ padding: "8px 14px", borderBottom: "1px dashed var(--rule-soft)", fontSize: 10, color: "var(--ink-3)", letterSpacing: 1, textTransform: "uppercase", fontWeight: 700, display: "flex", alignItems: "center", gap: 8 }}>
                  Your decision
                  <span style={{ background: "var(--paper-2)", border: "1px solid var(--rule-soft)", borderRadius: 99, padding: "1px 8px", letterSpacing: 0.5 }}>state · awaiting input</span>
                  <span style={{ marginLeft: "auto", textTransform: "none", letterSpacing: 0 }}>PM is read-only here — nothing leaves until you click.</span>
                </div>
...
Object.assign(window, {
  ANN, AnnPill, Note,
  Mission_Reviewer_Full, AnnRow, DiffLine,
