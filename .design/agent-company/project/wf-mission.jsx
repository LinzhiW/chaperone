      ...
      <div style={{ display: "flex", flexDirection: "column", flex: 1, minHeight: 0 }}>
        ...
        <div style={{ display: "flex", flex: 1, minHeight: 0 }}>
          ...
          <div style={{ flex: 1, display: "flex", flexDirection: "column", minHeight: 0, background: "var(--paper-2)" }}>
            ...
            <div style={{ flex: 1, padding: 14, display: "flex", flexDirection: "column", gap: 12, minHeight: 0, overflow: "hidden" }} data-comment-anchor="ebd7627b99-div-43-13">
            ...
            <div style={{ flex: 1, padding: 14, display: "flex", flexDirection: "column", gap: 10, minHeight: 0 }}>
              ...
              <div style={{ flex: 1, display: "grid", gridTemplateColumns: "1fr 1.4fr", gap: 10, minHeight: 0 }}>
                ...
                <div className="box" style={{ padding: 0, display: "flex", flexDirection: "column", minHeight: 0, overflow: "hidden" }}>
                  ...
                  <div className="wf-scroll" style={{ flex: 1, overflow: "auto", padding: 10, display: "flex", flexDirection: "column", gap: 6 }}>
                    {issues.map((it, idx) =>
                ...
                <div className="box" style={{ padding: 0, display: "flex", flexDirection: "column", minHeight: 0, overflow: "hidden" }}>
                  ...
                  <div className="wf-scroll" style={{ flex: 1, overflow: "auto", padding: 10, fontFamily: "var(--mono)", fontSize: 11, lineHeight: 1.55 }}>
