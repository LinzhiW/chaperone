...
const App: React.FC = () => {
  ...
  if (onboardingPhase === 'ready') {
    return (
      <div className="wf" style={{ flexDirection: 'row', height: '100vh' }}>
        <MissionRail
          projectName={config.projectPath.split(/[\\/]/).pop() || 'Agent Company'}
          onProjectClick={() => {}}
          onNewProject={() => {}}
          onSettings={() => setShowSettings(true)}
        />
  ...
  return (
    <div style={{ display: 'flex', height: '100vh', background: 'var(--paper)', color: 'var(--ink)', overflow: 'hidden', fontFamily: 'var(--sans)', fontSize: 13 }}>
      ...
      <MissionRail
        projectName={config.projectPath ? (config.projectPath.split(/[\\/]/).pop() || 'Agent Company') : 'Agent Company'}
